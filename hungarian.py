...
model = pickle.load(open("model/knn_oversampling+tuning_model.pkl", 'rb'))
...
st.write(f"**_Model's Accuracy_** :  :green[**{accuracy}**]% (:red[_Model in Use : KNN with Oversampling & Tuning_])")
st.write("")
